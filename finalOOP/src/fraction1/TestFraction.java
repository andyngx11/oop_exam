...
public class TestFraction {
    ...
    public static void main(String[] args) {
        /* TODO:
         ...
         - Nén các file source code và file text kết quả chạy chương trình vào file zip có tên
           ...
           nộp lên classroom.
         */
        System.out.println("=== Test MyArrayDataSet ===");
    ...
    public void testMyArrayDataSet() {
        ...
        */
        ...
        MyArrayDataSet data = new MyArrayDataSet();

        // Tạo ngẫu nhiên phân số
        for (int i = 0; i < numbers; i++) {
            int num = rand.nextInt(100) + 1;
            int den = rand.nextInt(100) + 1;
            data.append(new MyFraction(num, den));
        }
        ...
        System.out.println("\nSorted increasing:");
        data.sortIncreasing().print();

        System.out.println("\nSorted decreasing:");
        data.sortDecreasing().print();

        System.out.println("\nSimplified fractions (original order):");
        data.toSimplify().print();

        System.out.println("\nSimplified fractions (increasing):");
        data.toSimplify().sortIncreasing().print();

        System.out.println("\nSimplified fractions (decreasing):");
        data.toSimplify().sortDecreasing().print();
    }
    ...
    public void testMyListDataSet() {
        ...
        */
        Random rand = new Random();
        int numbers = rand.nextInt(21) + 30; // [30, 50]
        MyListDataSet data = new MyListDataSet();
